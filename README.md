...
* §4.4.2/4.4.3 — the effect-side relation `≈` (`State.Approx`); every
  ...
  once a fiber is `unloading`, the only lifecycle step on it is `L-Unload`
