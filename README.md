...
metatheory built on confinement (§4.4.2–4.4.5: recovery exactness,
resolution coherence, termination, confluence).  With those invariants the
full progress theorem (`exists_lstep_of_not_quiet_of_acyclic`) is already
proved; termination (Thm 66.2) and confluence (Thm 73) remain open.
